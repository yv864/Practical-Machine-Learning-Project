...
```{r}
library(caret)
training_parition <- createDataPartition(pmltraining$classe, list=FALSE, p=.9)
...
We need to use "random forest" to build the model.
...
Aa a consequencee, the model outcomes prediction accuracy greater than 99%. Therefore, this model serves well to predict new data.
